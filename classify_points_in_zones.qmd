...
classified_data <- read.csv("./data/classified_survey_data.csv", stringsAsFactors = FALSE)

# Count the number of points in each zone
zone_counts <- classified_data %>%
  count(zone)

# Create a bar plot
ggplot(zone_counts, aes(x = zone, y = n, fill = zone)) +
  geom_bar(stat = "identity") +
  labs(title = "Number of Points Classified in Each Zone", x = "Zone", y = "Count") +
  theme_minimal() +
